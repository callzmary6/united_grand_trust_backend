...
ROOT_URLCONF = 'united_sky_trust.urls'
...
WSGI_APPLICATION = 'united_sky_trust.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'authentication.authentications.JWTAuthentication',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'United Heritage Trust',
    'DESCRIPTION': 'An Easy Banking Website',
    'VERSION': '1.0.0',
...
# SMS_BROADCAST_TO_NUMBERS = ['+2349067195266']
